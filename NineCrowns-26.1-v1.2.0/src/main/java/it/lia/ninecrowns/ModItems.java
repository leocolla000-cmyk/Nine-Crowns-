...
public final class ModItems {
 ...
 public static void init(){
  ...
  SPEAR=register("op_spear",p->new SpearItem(p.spear(ToolMaterial.DIAMOND,1.05f,1.075f,.5f,3f,10f,6.5f,5.1f,10f,4.6f).attributes(weapon(9,-3)).component(DataComponents.MINIMUM_ATTACK_CHARGE,1f)));
